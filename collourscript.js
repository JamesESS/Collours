...
function randomColor() {
    ...
    colours[0].hsl[0] = Math.floor(Math.random()*360); //should ideally change all to Math.floor instead of round for better consistency
    colours[0].hsl[1] = Math.floor(Math.random()*(100-30 +1)+30); //to get correct max min *(max-min+1) + min
    colours[0].hsl[2] = Math.floor(Math.random()*(70-30 +1)+30);
    // console.log("random"+colours[0].hsl[0]);
}
